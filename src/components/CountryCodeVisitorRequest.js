...
import ListItemCountryCodeVisitorRequest from './ListItemCountryCodeVisitorRequest'
import { white_Original, red_lighter, grey, grey_lighter } from './common'
import Card from './card'
import {Actions} from 'react-native-router-flux'

class CountryCodeVisitorRequest extends Component {
    ...
    renderRow(Codes) {
        return <ListItemCountryCodeVisitorRequest
            code={Codes} />
    }
...
export default connect(mapStateToProps, { Code })(CountryCodeVisitorRequest);
