...
import { Text, View, Image, AsyncStorage, DeviceEventEmitter, BackHandler,Dimensions, TouchableWithoutFeedback, ActivityIndicator, FlatList, TouchableOpacity, Platform, Alert } from 'react-native'
