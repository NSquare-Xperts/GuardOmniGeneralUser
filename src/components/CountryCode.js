...
import { View, Image, Text, ListView, ScrollView, TextInput, TouchableOpacity } from 'react-native';
import { connect } from 'react-redux';
import { Code } from '../actions';
import ListItemCountryCode from './ListItemCountryCode';
import { white_Original, red_lighter, grey, grey_lighter, pink } from './common';
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, backgroundColor: red_lighter, flexDirection: 'column' }}>
                <Card>
                    ...
                    <View style={styles.SectionStyle}>
                        ...
                        <TextInput
                            ...
                            style={{ flex: 1,backgroundColor: white_Original
                                // borderWidth: 2, paddingLeft: 20, marginTop: 45, marginBottom: 15, height: 55, borderRadius: 40, backgroundColor: white_Original, borderColor: grey_lighter,
                                // marginBottom: 15
                            }}
                ...
                <View style={{ height: 0.6, width: '100%', backgroundColor: grey, marginTop: 25, marginBottom: 10 }} />
