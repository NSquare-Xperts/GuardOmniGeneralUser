...
import { Text, View, SectionList, Alert, Image } from "react-native"
...
import GuardManualOut1SubItem from "./common/GuardManualOut1SubItem";
//import { Picker } from "native-base"
//import GuardManualOut from "./GuardManualOut"

class GuardManualOut1 extends Component {
  state = {
    refreshing: true,
    sections: [
      {
      ...
      <ScrollView>
        <View style={{ backgroundColor: red_lighter, flex: 1 }}>
          <View style={styles.container}>
            ...
            <View style={{ marginLeft: 20, flexDirection: 'row', width: '90%' }}>
              <Text style={styles.textStyle}>In Visitors List</Text>
              ...
              <MenuProvider
                ...
                <Menu>                  
                  <MenuTrigger>
                  <Image
                        source={require('./assets/guard/manualOut/filter_icon.png')}
            ...
            <SectionList
              ...
              renderItem={({ item }) => <GuardManualOut1SubItem name={item.name}
              image={item.image} />}
...
export default GuardManualOut1;
