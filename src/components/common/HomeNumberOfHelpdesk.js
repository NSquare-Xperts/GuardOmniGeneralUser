...
import { white_Original, blue } from './color';

//make component 
const HomeNumberOfHelpdesk = () => {
      ...
      <View style={container}>
        <View style={gridRowStyle}>
              <Image  style={thumbnail}
                      source={require('../assets/Notices/helpdesk_option_large.png')}/>
                      <View style={gridColStyle}>
                          <Text style={textTitleStyle}>Helpdesk</Text>
                          <Text style={textStyle}>Click on Number to Call</Text>
                      </View>
         </View>             
      </View>
...
export default HomeNumberOfHelpdesk;
